<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('admin.wholesale-content.store') }}" class="rounded-3xl border border-stone-100 bg-white/90 p-6 shadow-lg space-y-5">
                @csrf
                @include('admin.wholesale-content.partials.form')

                <div class="flex items-center gap-3">
                    <button class="rounded-full bg-emerald-600 px-5 py-2 text-white shadow-sm hover:bg-emerald-500" type="submit">Create</button>
